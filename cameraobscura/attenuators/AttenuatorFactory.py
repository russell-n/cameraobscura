...
class AttenuatorFactory(object):
    """
    Factory class for selecting type of attenuator
    """
    _attenuators = {}
    ...
    def GetAttenuator(cls, attenuator_type, ip_address):
        ...
        :Parameters:
         - `attenuator_type`: Name of class to control attenuator, e.g. "AdeptN"
        ...
        if check not in AttenuatorFactory._attenuators:
            try:
            ...
            AttenuatorFactory._attenuators[check] = new_attenuator
        return AttenuatorFactory._attenuators[check]
# end AttenuatorFactory